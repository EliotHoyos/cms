...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'clients/new',
        loadComponent: () => import('./demo/pages/clients/client-form/client-form.component')
      },
      {
        path: 'instructors',
        loadComponent: () => import('./demo/pages/instructors/instructor-list/instructor-list.component')
      }
    ]
  },
  {
